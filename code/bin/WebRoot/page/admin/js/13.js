...
var itemtemplate='<tr id="traid">'
	...
	+'<td>date</td>'
	+'<td>'
		+'<button onclick="create(aid)" class="btntable" style="margin-right:10px"><img src="page/admin/images/edit.png" />修改创建者</button>'
		+'<button onclick="dismiss(aid)" class="btntable"><img src="page/admin/images/delete.png" />解散群</button>'
	+'</td></tr>';
var grpid = 0;
