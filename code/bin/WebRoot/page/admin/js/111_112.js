var branchmembertemplate=[
	"<tr>" +
		...
		"<td>position</td>" +
		"<td>" +
		"<img src='page/admin/images/edit.png' style='margin-right: 15px;cursor:pointer' onclick='editbranchmember(branchmemberid)' />" +
		"<img src='page/admin/images/delete.png' style='cursor:pointer' onclick='delbranchmember(branchmemberid)' />" +
		"</td></tr>",
	"<tr>" +
