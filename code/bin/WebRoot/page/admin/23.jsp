...
<script src="page/admin/js/23.js"></script>
</head>
<body>
<div id='container'>
...
<div class="menupanel12">
	<div id="jb" class="sidebar12">
		<div class="menu" onclick='window.location.href="21.jsp";'><img src='page/admin/images/role.png' class='menuicon'>成员身份权限</div>
		<div class="menu" onclick='window.location.href="#";'><img src='page/admin/images/advanced.png' class='menuicon'>高级功能</div>
		<div class="menu menuactive"><img src='page/admin/images/position.png' class='menuicon'>职务职位</div>
	</div>
</div>
