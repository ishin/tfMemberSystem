...
<head lang="en">
    <meta charset="UTF-8">
    <title></title>
    <link rel="stylesheet" href="<%=request.getContextPath() %>/page/cms/css/signin.css"/>
    <link rel="stylesheet" href="<%=request.getContextPath() %>/page/cms/css/window.css"/>
    <script src="<%=request.getContextPath() %>/page/cms/js/jquery-2.1.1.min.js"></script>
	<script src="<%=request.getContextPath() %>/page/cms/js/signin.js"></script>
...
<div class="signin-bg">
    <div class="signin-logo">
        <div class="main clearfix">
            <a href=""></a>
            <a class="pull-left ng-binding" onclick="jumpToAuth()"></a>
            <a class="recoLogo">统一认证平台</a>
        </div>
    </div>
