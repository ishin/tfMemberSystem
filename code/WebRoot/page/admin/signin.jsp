...
<head lang="en">
    <meta charset="UTF-8">
    <title></title>
    <link rel="stylesheet" href="<%=request.getContextPath() %>/page/admin/css/signin.css"/>
    <link rel="stylesheet" href="<%=request.getContextPath() %>/page/admin/css/window.css"/>
    <script src="<%=request.getContextPath() %>/page/admin/js/jquery-2.1.1.min.js"></script>
	<script src="<%=request.getContextPath() %>/page/admin/js/signin.js"></script>
    <script src="<%=request.getContextPath() %>/page/admin/js/md5.js"></script>
    <script src="<%=request.getContextPath() %>/page/admin/js/window.js"></script>
