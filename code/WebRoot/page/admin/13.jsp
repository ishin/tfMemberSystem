...
<script src="page/admin/js/13.js"></script>
</head>
<body>
<div id='container'>
...
<div class="menupanel12">
	<div id="jb" class="sidebar12">
		...
		<div class="menu menuactive"><img src='page/admin/images/group.png' class='menuicon'>群组管理</div>
	</div>
</div>
...
<!-- 				<tr>
 ...
 -->			</tbody>
			...
			<div style='margin: 30px 0'>
				<div class='toright leftspace15' id='pagelast'><img src='page/admin/images/lastpage_1.png' /></div>
				<div class='toright leftspace15' id='pagenext'><img src='page/admin/images/next_1.png' /></div>
				<div class='toright leftspace15' id='pagecurr'>1/10</div>
				<div class='toright leftspace15' id='pageprev'><img src='page/admin/images/back_1.png' /></div>
				<div class='toright leftspace15' id='pagefirst'><img src='page/admin/images/firstpage_1.png' /></div>
			</div>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		</div>
