...
public class HttpRequest {
	...
	public String sendPost(String fun, JSONObject params) {
		...
		try {
			...
			if (protocol.equalsIgnoreCase("http")) {
				result = httpRequestHttp(fun, params);
			} else if (protocol.equalsIgnoreCase("https")) {
				result = httpRequestHttps(fun, params);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private String httpRequestHttp(String fun, JSONObject params) {
		String result = "";
	...
	private String httpRequestHttps(String fun, JSONObject params) {
