...
- (void)initial
{
    ...
    // 4.箭头图片
    UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"refresh.png"]];
    ...
    activityView.color=THEME_COLOR;
...
- (void)setFrameHeader
{
    ...
    // 3.箭头
    _arrowImage.center = CGPointMake(101, 65 * 0.5-17.5);
