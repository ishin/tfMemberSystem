...
#define kReleaseToRefresh @"松开立即可刷新"
...
- (void)updateTimeLabel
{
    ...
    if(_themeColor == nil)
        _lastUpdateTimeLabel.textColor = THEME_COLOR;
    else
        _lastUpdateTimeLabel.textColor = _themeColor;
...
{
    if(_themeColor)
        _activityView.tintColor = _themeColor;
    ...
    if(_themeColor == nil)
        ...
        _statusLabel.textColor = _themeColor;
