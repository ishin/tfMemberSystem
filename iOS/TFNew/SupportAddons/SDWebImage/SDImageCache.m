...
- (NSString *)cachePathForKey:(NSString *)key
{
    ...
    NSRange range = [key rangeOfString:specialMd5];
    NSString *keyMd5 = @"";
    if(range.location != NSNotFound)
    {
        keyMd5 = [key substringFromIndex:range.location+[specialMd5 length]];
    }
    if([keyMd5 length] > 5)
    {
        return [self.diskCachePath stringByAppendingPathComponent:keyMd5];
    }
