...
- (UIView *)createContainerView
{
    ...
    CGFloat cornerRadius = kRCCustomIOSAlertViewCornerRadius;
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, dialogContainer.bounds.size.height - rcButtonHeight - rcButtonSpacerHeight, dialogContainer.bounds.size.width, rcButtonSpacerHeight)];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setFrame:CGRectMake(i * buttonWidth, container.bounds.size.height - rcButtonHeight, buttonWidth, rcButtonHeight)];
        ...
        if (i == [buttonTitles count] - 1) {
            UIView *line = [[UIView alloc] initWithFrame:CGRectMake(i * buttonWidth, container.bounds.size.height - rcButtonHeight, 1, rcButtonHeight)];
