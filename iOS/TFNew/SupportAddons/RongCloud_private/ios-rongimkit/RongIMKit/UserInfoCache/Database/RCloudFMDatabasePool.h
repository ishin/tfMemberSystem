...
/** Synchronously perform database operations in pool using save point.
 ...
 @warning You can not nest these, since calling it will pull another database out of the pool and you'll get a deadlock. If you need to nest, use `<[RCloudFMDatabase startSavePointWithName:error:]>` instead.
*/
