...
-(RCGroup *)translateToGroupInfo {
    if (self.conversationType == ConversationType_GROUP) {
        return [[RCGroup alloc]initWithGroupId:self.targetId
                                     groupName:self.name
...
- (BOOL)isEqual:(id)object {
    if ([object isKindOfClass:[self class]]) {
        ...
        return [_targetId isEqualToString:o.targetId] && (_conversationType == o.conversationType) && (_portraitUri == o.portraitUri || [_portraitUri isEqualToString:o.portraitUri]) && (_name == o.name || [_name isEqualToString:o.name]);
    }
    return NO;
}
@end
