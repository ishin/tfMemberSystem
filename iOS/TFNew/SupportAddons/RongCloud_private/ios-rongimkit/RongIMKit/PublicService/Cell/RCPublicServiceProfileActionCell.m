...
- (void)setup {
    ...
    frame.size.width = self.frame.size.width - RCPublicServiceProfileCellPaddingLeft - RCPublicServiceProfileCellPaddingRight;
    ...
    self.button.titleLabel.font = [UIFont systemFontOfSize:RCPublicServiceProfileBigFont];
