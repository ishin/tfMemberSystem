...
public class MineGroupParentBean implements Serializable {

    private String code;
    private Text text;

    public MineGroupParentBean(String code, Text text) {
        this.code = code;
        this.text = text;
    }
    ...
    public static class Text {
        private List<ICreate> ICreate;
        private List<IJoin> IJoin;

        public Text(List<Text.ICreate> ICreate, List<Text.IJoin> IJoin) {
            this.ICreate = ICreate;
            this.IJoin = IJoin;
        }

        public List<Text.ICreate> getICreate() {
            return ICreate;
        }

        public void setICreate(List<Text.ICreate> ICreate) {
            this.ICreate = ICreate;
        }

        public List<Text.IJoin> getIJoin() {
            return IJoin;
        }

        public void setIJoin(List<Text.IJoin> IJoin) {
            this.IJoin = IJoin;
        }
