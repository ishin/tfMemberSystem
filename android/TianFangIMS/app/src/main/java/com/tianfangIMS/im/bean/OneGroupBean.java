...
/**
 * Created by LianMengYu on 2017/2/12.
 * 接受单个群组信息
 */

public class OneGroupBean implements Serializable {
    private static final long serialVersionUID = -2642333866463319389L;
    private String code;
    private Text text;

    public OneGroupBean(String code, Text text) {
        this.code = code;
        this.text = text;
    }
